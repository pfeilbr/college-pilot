...
window.SCHOOLS['pennstate'] = {
  ...
  <div class="cards g2" style="margin-top:16px">
    ...
    <div class="card">
      ...
      <ul>
        ...
        <li>Median earnings 10 years after entry: <b>$63,435</b> — among the lower on this list (Ohio State and South Carolina sit just below), diluted by the huge major mix; Smeal outcomes run well above it</li>
  ...
  <div class="cards g2">
    ...
    <div class="pc cons">
      ...
      <ul>
        ...
        <li>Among the lower measured earnings here<small>$63.4K median at 10 years (all majors — Smeal runs higher)</small></li>
      </ul>
    </div>
  </div>`
    },
  ...
  <div class="note">💡 <b>Good tour questions for a business kid:</b> What are the current entrance-to-major GPA cutoffs for finance and supply chain? What percent of pre-majors make their first-choice major? How early can freshmen join business clubs and the career fair circuit?</div>`
    },
    {
      ...
      html: `
  <div class="cards g3">
    <div class="card"><h3>🍦 Berkey Creamery</h3><p>The country's largest university creamery — the single mandatory stop of the entire thirteen-school tour.</p></div>
